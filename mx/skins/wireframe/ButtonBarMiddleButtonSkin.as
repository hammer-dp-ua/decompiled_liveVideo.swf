package mx.skins.wireframe
{
   ...
   public class ButtonBarMiddleButtonSkin extends Skin implements IStateClient2
   {
       
      
      public var _ButtonBarMiddleButtonSkin_Rect1:Rect;
      ...
      public function ButtonBarMiddleButtonSkin()
      {
         ...
         this.minWidth = 21;
         this.minHeight = 21;
         this.mxmlContent = [this._ButtonBarMiddleButtonSkin_Rect1_i(),this._ButtonBarMiddleButtonSkin_Rect6_c()];
         this.currentState = "up";
         var _loc1_:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._ButtonBarMiddleButtonSkin_Rect2_i);
         var _loc2_:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._ButtonBarMiddleButtonSkin_Rect3_i);
         var _loc3_:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._ButtonBarMiddleButtonSkin_Rect4_i);
         var _loc4_:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._ButtonBarMiddleButtonSkin_Rect5_i);
         states = [new State({
            "name":"up",
            "overrides":[]
         }),new State({
            ...
            "overrides":[new AddItems().initializeFromObject({
               ...
               "position":"after",
               "relativeTo":["_ButtonBarMiddleButtonSkin_Rect1"]
      ...
      private function _ButtonBarMiddleButtonSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.initialized(this,"_ButtonBarMiddleButtonSkin_Rect1");
         this._ButtonBarMiddleButtonSkin_Rect1 = _loc1_;
         BindingManager.executeBindings(this,"_ButtonBarMiddleButtonSkin_Rect1",this._ButtonBarMiddleButtonSkin_Rect1);
         return _loc1_;
      }
      ...
      private function _ButtonBarMiddleButtonSkin_Rect2_i() : Rect
      {
         ...
         _loc1_.right = 1;
         _loc1_.height = 1;
         _loc1_.fill = this._ButtonBarMiddleButtonSkin_SolidColor2_c();
      ...
      private function _ButtonBarMiddleButtonSkin_SolidColor2_c() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
      ...
      private function _ButtonBarMiddleButtonSkin_Rect3_i() : Rect
      {
         ...
         _loc1_.right = 1;
         _loc1_.height = 1;
         _loc1_.fill = this._ButtonBarMiddleButtonSkin_SolidColor3_c();
      ...
      private function _ButtonBarMiddleButtonSkin_SolidColor3_c() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
         _loc1_.color = 6052956;
         _loc1_.alpha = 0.07;
      ...
      private function _ButtonBarMiddleButtonSkin_Rect4_i() : Rect
      {
         ...
         _loc1_.bottom = 1;
         _loc1_.width = 1;
         _loc1_.fill = this._ButtonBarMiddleButtonSkin_SolidColor4_c();
      ...
      private function _ButtonBarMiddleButtonSkin_SolidColor4_c() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
         _loc1_.color = 6052956;
         _loc1_.alpha = 0.07;
      ...
      private function _ButtonBarMiddleButtonSkin_Rect5_i() : Rect
      {
         ...
         _loc1_.bottom = 1;
         _loc1_.width = 1;
         _loc1_.fill = this._ButtonBarMiddleButtonSkin_SolidColor5_c();
      ...
      private function _ButtonBarMiddleButtonSkin_SolidColor5_c() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
         _loc1_.color = 6052956;
         _loc1_.alpha = 0.07;
      ...
      private function _ButtonBarMiddleButtonSkin_Rect6_c() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.left = 0;
         _loc1_.right = 0;
