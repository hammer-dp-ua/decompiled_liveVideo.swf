package mx.skins.wireframe
{
   ...
   public class MenuSkin extends Skin implements IStateClient2
   {
      ...
      public function MenuSkin()
      {
         ...
         this.mxmlContent = [this._MenuSkin_Rect1_i()];
      ...
      private function _MenuSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.stroke = this._MenuSkin_SolidColorStroke1_i();
         _loc1_.fill = this._MenuSkin_SolidColor1_i();
      ...
      private function _MenuSkin_SolidColorStroke1_i() : SolidColorStroke
      {
      ...
      private function _MenuSkin_SolidColor1_i() : SolidColor
      {
