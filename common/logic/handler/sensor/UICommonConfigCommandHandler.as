package common.logic.handler.sensor
{
   ...
   public class UICommonConfigCommandHandler implements ICommandHandler
   {
      ...
      public function UICommonConfigCommandHandler(param1:TCPTransfer, param2:int)
      {
         super();
      ...
      public function sendCommand(param1:int = 0) : int
      {
         ...
         _loc2_.SubCommandId = SensorConfigureCommand.GET_UI_COMMON_CONFIG_REQUEST;
         var _loc3_:ByteArray = new ByteArray();
         DataConvert.convert(this.m_iLanguageId,_loc3_);
         _loc2_.SubCommandBody = _loc3_.readMultiByte(_loc3_.bytesAvailable,CommonConst.SOCKET_DATA_ENCODE_UTF);
      ...
      public function handleCommand(param1:Buffer) : int
      {
         ...
         SensorUIData.m_strUICommon = _loc5_;
