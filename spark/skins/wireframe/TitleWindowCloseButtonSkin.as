package spark.skins.wireframe
{
   ...
   public class TitleWindowCloseButtonSkin extends Skin implements IStateClient2
   {
      ...
      public function TitleWindowCloseButtonSkin()
      {
         ...
         this.mxmlContent = [this._TitleWindowCloseButtonSkin_RectangularDropShadow1_i(),this._TitleWindowCloseButtonSkin_Rect1_c(),this._TitleWindowCloseButtonSkin_Rect2_i(),this._TitleWindowCloseButtonSkin_Group1_c()];
      ...
      private function _TitleWindowCloseButtonSkin_Path1_c() : Path
      {
         ...
         _loc1_.fill = this._TitleWindowCloseButtonSkin_SolidColor3_c();
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _TitleWindowCloseButtonSkin_SolidColor3_c() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
      ...
      private function _TitleWindowCloseButtonSkin_Path2_c() : Path
      {
         ...
         _loc1_.fill = this._TitleWindowCloseButtonSkin_SolidColor4_c();
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _TitleWindowCloseButtonSkin_SolidColor4_c() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
         _loc1_.color = 6710886;
         return _loc1_;
