package spark.skins.wireframe
{
   ...
   public class ApplicationSkin extends Skin implements IStateClient2
   {
      ...
      private function _ApplicationSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.fill = this._ApplicationSkin_SolidColor1_c();
      ...
      private function _ApplicationSkin_SolidColor1_c() : SolidColor
      {
      ...
      private function _ApplicationSkin_Group2_i() : Group
      {
         ...
         _loc1_.minWidth = 0;
         _loc1_.minHeight = 0;
         _loc1_.mxmlContent = [this._ApplicationSkin_Rect2_c(),this._ApplicationSkin_Rect3_c(),this._ApplicationSkin_Group3_i()];
         _loc1_.id = "topGroup";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _ApplicationSkin_Rect3_c() : Rect
      {
         ...
         _loc1_.bottom = 0;
         _loc1_.height = 1;
         _loc1_.fill = this._ApplicationSkin_SolidColor3_c();
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _ApplicationSkin_SolidColor3_c() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
