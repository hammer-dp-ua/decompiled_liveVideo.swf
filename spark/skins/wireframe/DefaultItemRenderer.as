package spark.skins.wireframe
{
   ...
   public class DefaultItemRenderer extends UIComponent implements IDataRenderer, IItemRenderer
   {
      ...
      override protected function measure() : void
      {
         ...
         measuredHeight = this.labelDisplay.getPreferredBoundsHeight() + 13;
         measuredMinWidth = this.labelDisplay.getMinBoundsWidth() + 6;
         measuredMinHeight = this.labelDisplay.getMinBoundsHeight() + 13;
      }
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         this.labelDisplay.setLayoutBoundsPosition(3,7);
      }
